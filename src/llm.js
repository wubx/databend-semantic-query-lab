    ...
    [
      {
        ...
        content: [
          ...
          "For raw record/detail/list requests, set ungrouped to true, omit measures, and select useful public dimensions, time members, and public facts in dimensions so they appear as detail output columns. Set an explicit limit no greater than 100. Facts and time members are allowed in dimensions only when ungrouped is true. Ungrouped details may select at most 16 dimensions/time members/facts; timeDimensions remains available for date filtering. Use ungrouped false or omit it for grouped analysis and distinct dimension-value questions.",
